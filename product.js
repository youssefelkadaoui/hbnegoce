...
checkoutForm.addEventListener('submit', async (e) => {
  ...
  document.getElementById('formThankYouUrl').value = new URL('thank-you.html', window.location.href).href;
  checkoutForm.submit();
  ...
  document.getElementById('productContent').innerHTML = `
    <div class="pd-layout">
      ...
      <div class="pd-details">
        ...
        <div class="pd-stock pd-limited-stock"><i class="fas fa-fire"></i> الكمية محدودة</div>
        <div class="pd-specs">
